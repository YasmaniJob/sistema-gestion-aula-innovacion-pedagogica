...
export default function NewLoanPage() {
  ...
  usePageTitle('Solicitar Préstamo');
  const { currentUser, addLoan, resources: allResources, areas, grades } = useData();
  ...
  const handleRegisterLoan = async () => {
    ...
    setTimeout(() => {
        ...
        toast({
            ...
            description: `Tu solicitud de préstamo para ${selectedResources.length} recurso(s) ha sido enviada para aprobación.`,
            variant: 'default',
        });
      ...
      <div className="flex items-center justify-between">
        <div className="hidden sm:flex items-center gap-4">
          <div className="flex items-center text-sm text-muted-foreground">
            ...
            <span className="font-medium text-primary">Solicitar Préstamo</span>
          </div>
        </div>
      </div>
      <h1 className="text-3xl font-bold hidden sm:block">Solicitar Préstamo de Recursos</h1>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-2 space-y-8">
          <Card>
            <CardHeader>
              <CardTitle>1. Detalles de la Solicitud</CardTitle>
            </CardHeader>
